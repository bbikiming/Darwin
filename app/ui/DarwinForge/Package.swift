...
let package = Package(
    // V274-6: ViewInspector 0.10.3 PoC dependency — 2026-05-24
    name: "DarwinForge",
    ...
    dependencies: [
        // V274-6: ViewInspector PoC — SwiftUI view tree introspection (2026-05-24).
        // 0.10.3 지원: @State, @Binding, @ObservedObject, @EnvironmentObject.
        // @Observable (@Environment) view 는 ViewHosting 패턴 필요 — PoC 에서 검증.
