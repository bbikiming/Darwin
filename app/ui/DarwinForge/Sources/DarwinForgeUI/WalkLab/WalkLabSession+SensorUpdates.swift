...
/// **v1.22.0 (2026-05-22) — 사이클 97: god object Phase 3 분할 (architect agent plan)**.
///
/// `WalkLabSession.swift` (4331 line) 의 sensor update method 묶음 (~168 line) 를 본
/// extension 으로 이동. tick() 매 cycle 호출되는 voltage / IMU / motor thermal 의
/// real-or-sim 분기 + sim model evolution 5개 method 가 대상.
///
/// # 비유
///
...
///   `updateVoltageDroopTracking` 와 tick() 의 본체 trigger gate 양쪽이 본 상수 read.
