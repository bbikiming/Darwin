...
| [walklab-onboard-teleop-upgrade.md](walklab-onboard-teleop-upgrade.md) | 로봇 측 코드·알고리즘 + 명령/텔레메트리 계약 | 2507be6 | **O0 코드 ✅**(TEL ≥11+last_cmd_id/loop_ms·RobotClockSync·tracer ackReceived, P3) · **O1 코드 ✅**(WalkLabTransport 순수 로직+호스트 테스트 63 checks·브로커리지 UDP 리스너 17372/17374·supervisor 20ms·워치독 티어 600/2500ms 스트림 소스 전용·RefreshHandshake·파일 폴백 보존, P3) · 실기 배포(demoBuildPatched)·벤치(≥20Hz·E-STOP p95) ⬜ · O2~O4 ⬜ |
