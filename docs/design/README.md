...
| 문서 | 영역 | 설계 커밋 | 구현 현황 |
|---|---|---|---|
| [cockpit-latency-hardening.md](cockpit-latency-hardening.md) | Mac 전송·입력·시리얼 (확정 이슈 35건) | cf132bd | **W0 ✅**(66039c6·8139247) · **W2 ✅**(e0bb2cf·da495d6·7808fdb·c62d3af·a61afbc·9dff323) · W3 부분(J1 fe8d748, J9 0153464) · **W1 ⬜**(온보드 O1과 한 묶음) · 잔여 J4→D0, J13→D0 이관 |
...
| [bus-direct-teleop-upgrade.md](bus-direct-teleop-upgrade.md) | 직결(bus) 조종 — 50Hz 연속 스트리밍 | b54daff | D0~D3 전부 ⬜ (전송 선행분 L5·J11·J12·S4 는 기완료) |
